<main class="main_content">
   ...
   <div class="wow zoomIn"><a  href="../../employees/products" class="btn"><span><img src="<?php echo base_url(); ?>assets/images/rightIcon.svg" /></span> <span style="color: #000; position: relative; left: -15px;"><?php echo lang('back'); ?></span> </a></div>
   </div>
   ...
   <?php foreach($details['products']['data']['records'] as $product) { ?>
     <div class="single_product_page packageDetails">
