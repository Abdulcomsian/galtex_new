...
<?php if($details['remaining_quantity'] > 0) { ?>
                      ...
                      <?php } else { ?>
                        ...
                        <?php } else { ?>
                           <strong><a class="btn btn_common add-to-cart" href="javascript:void(0);"><?php echo lang('out_of_stock'); ?></a></strong>
                      <?php } } ?>
                      </div>
                      <div class="backToStore desktopHide">
                      <div class="wow zoomIn"><a  href="../../employees/products" class="btn"><img src="<?php echo base_url(); ?>assets/images/rightIcon.svg" /></span> <?php echo lang('back'); ?></span> <span style="color: #000; position: relative; left: -15px;"><span></a></div>
                      </div>
         ...
         <section class="inner_banner_sec productBg desktopHide" style="background-image: url(<?php echo $details['product_main_photo']; ?>);">
            <div class="innerbanner_cap text-center">
               <div class="container">
                  <div class="watermark_text">
                     <h1 class="head_1"><?php echo $details['product_name']; ?></h1>
                ...
                <div class="row">
                   <div class="col-lg-12 text-right">
                     <?php if($details['remaining_quantity']<=10){ ?>
                      <b style="padding:10px 0px; color: #373737;"><?php echo $details['remaining_quantity']; ?> <?php echo lang('last_item'); ?> </b>
                     <?php }?>
            ...
            <div class="row">
               ...
               <div class="col-md-6 cartDiv desktopHide">
                   <?php #if((details['remaining_quantity'] > 0) && !empty($details['above_budget_price'])) { 
                     ...
                     ?>
                     <p style="line-height: 22px;text-align: center;"> <?php echo lang('additional') .' ' .CURRENCY_SYMBOL. $details['above_budget_price'];?></p>
                  <?php } ?>
                     <div class="desktopHide" style="width: 100%;">
                  <?php if($details['remaining_quantity'] > 0) { ?>
                    
                      <?php } if($is_added_into_cart) { ?>
                        <div class="wow zoomIn mobileProductBtn"><a style="width: 100%; border: none;" href="../../employees/cart" class="btn btn_common"><?php echo lang('go_to_cart'); ?></a></div>
                      <?php } else { ?>
                        <?php if($details['remaining_quantity'] > 0) { ?>
                        ...
                        <?php } else { ?>
                           <div class="wow zoomIn mobileProductBtn"><a style="width: 100%; border: none;" href="javascript:void(0);" style="margin-top:10px;color:red;"><?php echo lang('out_of_stock'); ?></a></div>
                      <?php } } ?>
                      </div>
               </div>
               <!-- Hamza Custom Code Here - End -->
