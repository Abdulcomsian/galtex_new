<main class="main_content">
          ...
          <div class="innerbanner_cap text-center">
             <div class="container">
                <div class="watermark_text">
                   <h1 class="head_1" style="padding-bottom:35px;"><?php echo lang('checkout_title'); ?></h1>
                 <!--  <p class="watermark wow zoomIn mobileHide" data-wow-delay="0.4s"><?php #echo lang('checkout'); ?></p> -->
                </div>
             </div>
          </div>
       </section>
       <section class="checkout_sec">
          <div class="container">
                ...
                <div class="pb-5 text-center mobileHide">
                ...
                ?>
                <div class="row">
                  <div class="col-md-4 order-md-2 mb-4 mobileHide">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group focus_label">
                              <?php if(!isset($details['first_name'])) { ?> <label for="firstName"><?php echo lang('first_name'); ?></label> <?php } ?>
                          ...
                          <div class="col-md-6">
                            <div class="form-group focus_label">
                              <?php if(!isset($details['last_name'])) { ?> <label for="lastName"><?php echo lang('last_name'); ?></label> <?php } ?>
                          ...
                          <div class="col-md-12 desktopHideeee">
                           <!-- <div class="form-group focus_label">
                              ...
                              <input type="text" class="form-control" id="town" name="town" value="" required>
                            </div>
                          </div>
                          <div class="col-md-6 desktopHideee">
                             <div class="form-group focus_label">
