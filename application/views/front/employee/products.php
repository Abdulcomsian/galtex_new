               ...
               <div class="cat_sidebar">
                  <div class="sidebar_block">
                     ...
                     <ul class="list-unstyled catlist_item">
                        ...
                        <li class="wow fadeInLeft" data-wow-delay="0.6s">
                           <?php $checked=""; if( $category ===  'above'){$checked = "checked1";}else{$checked = "uncheck";} ?>
                           <input type="checkbox" id="chk_Canon" value="above" name="budget_category[]" class="budget-categories <?php echo $checked; ?> " <?php echo $category ===  'above' ? 'checked' : '' ?> />
                           <label for="chk_Canon">
                  ...
                  <div class="sidebar_block">
                     ...
                     <?php if($categories['data']['total_records']) {
                        ...
                        <li class="wow fadeInLeft" data-wow-delay="0.3s">
                           <input type="checkbox" id="category_<?php echo $category['category_guid']; ?>" name="main_category[]" value="<?php echo $category['category_guid']; ?>" <?php echo in_array($category['category_guid'], $main_categories) ? 'checked' : '' ?> class="main_categories" />
                  ...
                  if ($type === 'above') { ?>
                    ...
                    <div class="col-sm-12">
                            <h2 class="head_common2 wow fadeInRight" style="display: none;">
                               ...
                               <?php echo lang('products'); ?>(<?php echo addZero(@$above_the_budget_products['data']['total_records']); ?>)</h2>
                        </div>
                  ...
                  <div class="prod_coll col-sm-6 col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
                     <div class="proimage">
                        ...
                        <div class="pro_bottom clerfix">
                           ...
                           <div class="readMore">
                              <a href="<?php echo base_url(); ?>product/details/<?php echo $product['product_guid']; ?>"><img src="<?php echo base_url(); ?>assets/images/rightIcon.svg" /> <?php echo lang('more_details'); ?></a>
                           </div>
                        </div>
                     </div>
                  </div>
...
?>
               ...
               <div class="list_row row">
                    <div class="col-sm-12" style="display: none;">
                            <h2 class="head_common2 wow fadeInRight mobileHide"><?php echo lang('products'); ?> (<?php echo addZero( @$within_the_budget_products['data']['total_records']); ?>)<span style="font-size: 10px;">Within the Budget</span></h2>
                        </div>
                  <?php foreach($within_the_budget_products['data']['records'] as $product) { ?>
                  <div class="prod_coll col-sm-6 col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
                     <div class="proimage">
               ...
               <div class="list_row packages_por row">
                  ...
                  <div class="col-sm-12" style="display: none;">
                     <h2 class="head_common2 wow fadeInRight mobileHide"><?php echo lang('packages'); ?> (<?php echo addZero($packages['data']['total_records']); ?>)</h2>
                  </div>
                  <?php } ?>
                  <!------ Single Image ---->
                  ...
                  <div class="prod_coll col-xs-6 col-sm-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                     <div class="proimage">
                        ...
                        <div class="pro_img_box ">
                           ...
                           <?php } ?>
                           <p class="tag"><?php echo lang('packages'); ?> </p>
                        </div>
                     <?php } else if(count($package['products']['data']['records'])==2)  { ?>
                        <div class="pro_img_box two_item">
                           <div class="row">
                           <?php  $j=0; foreach($package['products']['data']['records'] as $package_product) { 
                               #echo count($package_product);exit;
							  
                               ?>
                           <div class="col-6 twoimages first_col" <?php if($j==0){ ?> <?php }else if($j==1){ ?> class="second_col" <?php }  if($j==1){$j=0;} $j++;?>>
                              <a href="<?php echo base_url(); ?>package/details/<?php echo $package['package_guid']; ?>"><img style="height: 125px;" src="<?php echo $package_product['product_main_photo']; ?>" /></a>
                     ...
                     <?php } else if(count($package['products']['data']['records'])==3) { 
                        ...
                        ?>
                          <div class="pro_img_box three_item">
                           <div class="row">
                           <?php $i=0; $j=0; foreach($package['products']['data']['records'] as $package_product) {?>
                           <?php if($i==0){?>
                           <div class="col-6 first_col threeimages first_col">
                           <?php } ?>
                           <?php if($i==0 || $i==1){ ?>
                              <a href="<?php echo base_url(); ?>package/details/<?php echo $package['package_guid']; ?>"><img style="margin-bottom:3px; <?php if($i==1){ ?>margin-top:3px;<?php } ?>" src="<?php echo $package_product['product_main_photo']; ?>" /></a>
                           <?php } ?>
                           <?php if($i==1){?>
                           </div>
                           <?php } ?>
                           <?php if($i==2){?>
                              <div class="col-6 second_col">
                                <a href="<?php echo base_url(); ?>package/details/<?php echo $package['package_guid']; ?>"><img style="min-height: 125px;max-height: 125px;" src="<?php echo $package_product['product_main_photo']; ?>" /></a>
                              </div>
                           <?php }?>
                           <?php $i++;} ?>
                           </div>
                          ...
                          <!--  <div class="product_description">
                           ...
                           <div class="readMore">
                             <!--  <a href="<?php echo base_url(); ?>package/details/<?php echo $package['package_guid']; ?>"><img src="<?php echo base_url(); ?>assets/images/leftIcon.svg" /> <?php echo lang('more_details'); ?>  </a> -->
                              <a href="<?php echo base_url(); ?>package/details/<?php echo $package['package_guid']; ?>"><img src="<?php echo base_url(); ?>assets/images/rightIcon.svg" /> <?php echo lang('more_details'); ?>  </a>
               ...
               <div class="list_row row">
                    <div class="col-sm-12" style="display: none;">
                            <h2 class="head_common2 wow fadeInRight mobileHide"><?php echo lang('products'); ?> (<?php echo addZero( @$above_the_budget_products['data']['total_records']); ?>)<span style="font-size: 10px;"><?php echo lang('above_the_budget'); ?></span></h2>
                        </div>
                  <?php foreach($above_the_budget_products['data']['records'] as $product) { ?>
                  <div class="prod_coll col-sm-6 col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
                     <div class="proimage">
