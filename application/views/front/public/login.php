...
<body>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <!--   <div class="mobileHeader">
                    ...
                    <ul class="navbar-nav ml-auto">               
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo base_url(); ?>"><?php echo lang('cart'); ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo base_url(); ?>"><?php echo lang('personal_area'); ?></a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="col-md-12">
          <div class="card-body">
            ...
            <div class="card-text">
              ...
              <p class="note" style="display:none!important; font-family: 'AssistantBold'">
              ...
              <form method="post" id="login-form">
                <div style="display: flex;">
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="login_type" checked="" id="inlineRadio1"
                      value="OTP">
                    <label class="form-check-label" for="inlineRadio1">
                      <?php echo lang('otp_message'); ?>
                    </label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="login_type" id="inlineRadio2" value="Phone">
                    <label class="form-check-label" for="inlineRadio2">
                      <?php echo lang('phone_call'); ?>
                    </label>
                  </div>
                  <div class="form-check form-check-inline">
                ...
                <div class="form-group mobile_number wow fadeInLeft" data-wow-delay="0.4s">
                  ...
                  <input type="text" class="form-control" placeholder="<?php echo lang('mobile_number'); ?>" required=""
                    id="phoneNumber" name="phone_number" value="<?php if (isset($_COOKIE["phone_number"])) {
                ...
                <div class="form-group opt_group ">
                  ...
                  <input type="text" class="form-control prevent-copy-paste validate-no" id="phoneOtp" name="otp"
                    placeholder="<?php echo lang('enter_otp'); ?>" maxlength="6">
                </div>
                <div class="form-group password-section" style="display:none;">
                  <label for="password">
                    <?php echo lang('password'); ?>
                  </label>
                  <input type="password" class="form-control prevent-copy-paste" id="password" name="password"
                    placeholder="<?php echo lang('password'); ?>">
                </div>
                <!--  <div class="form-check wow fadeInLeft" ata-wow-delay="0.6s">
                    <input type="checkbox" class="form-check-input" name="is_remember" value="yes" <?php if (isset($_COOKIE["phone_number"])) {
                      echo 'checked';
                    } ?>>
                ...
                <button type="submit" class="btn_common btn btn-primary btn-block wow fadeInUp login-btn hidden"
                  data-wow-delay="0.8s">
                  <?php echo lang('login'); ?>
                </button>
                <div class="forgot_pass">
                  <a class="hover_dash" style="color: #7a349c" href="javascript" data-toggle="modal"
                    data-target="#havingTroubleModal">
                    <!-- <?php echo lang('having_trobule'); ?> -->
                  </a>
                </div>
              </form>
            </div>
  ...
  <!-- Modal Need Help -->
  <div class="modal fade" id="havingTroubleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">
            <?php echo lang('need_help'); ?>
          </h5>
        ...
        <div class="modal-body">
          <form method="post" id="help-form">
            <div class="form-group mobile_number">
              <label for="textArea">
                <?php echo lang('text_us'); ?>
              </label>
              <textarea class="form-control" required="" name="message" style="height:100px;"
                placeholder="<?php echo lang('type_here'); ?>"></textarea>
            </div>
            <center><button type="submit" class="btn_common btn btn-primary btn-block send-btn" style="width:100px;">
                <?php echo lang('send'); ?>
              </button></center>
          </form>
          <br />
    ...
    <section class="footer_top">
      ...
      <!-- <div class="footer_menu">
                    ...
                    <ul class="menu_list list-unstyled mb-0">
                            <li>
                               <a href="javascript:void(0);"><?php echo lang('Category'); ?></a>
                            </li>
                     </ul>
                    </div>
                    <div class="ftr_main_block">
                    <ul class="menu_list list-unstyled mb-0">
                            <li>
                               <a href="javascript:void(0);"><?php echo lang('Another_Category'); ?></a>
                            </li>
                     </ul>
                    </div>
                    <div class="ftr_main_block">
                    <ul class="menu_list list-unstyled mb-0">
                            <li>
                               <a href="javascript:void(0);"><?php echo lang('Someother_Category'); ?></a>
                            </li>
                     </ul>
                    </div>
                    <div class="ftr_main_block">
