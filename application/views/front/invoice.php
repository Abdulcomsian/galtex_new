...
<?php 
  ...
  ?>
<body style="<?php if($lang=='he') {echo 'text-align:right;direction:rtl;';} ?>margin:0;padding:0;word-spacing:normal;font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif; background-color: #fcfcff; font-family: 'Poppins', sans-serif; ">
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
				 <td style="vertical-align: middle; text-align: right; padding: 10px 40px;font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;font-family: 'Poppins', sans-serif;">
					<p style="margin-top: 0; margin-bottom: 0;font-size: 14px; <?php echo $details['theme_color']; ?>;"><?php echo lang('hello'); ?> <?php echo $details['employee_name']; ?>!</p>
					<p style="margin-top: 0; margin-bottom: 0;font-size: 14px;color: <?php echo $details['theme_color']; ?>"><?php echo lang('order_no'); ?> <?php echo "OID-".$details['order_id']; ?> <?php echo lang('completed_successfully'); ?></p>
				  </td>
			</tr>
            <tr>
