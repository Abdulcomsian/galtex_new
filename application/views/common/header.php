...
<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/slick-theme.css">
      ...
      <style type="text/css">
         ...
         .pro_img_box .productPrice{
            background: linear-gradient(to left,rgba(255,255,255,0.5),rgba(0,0,0,0.5)), <?php echo $color_code; ?>;
         ...
         .packages_por .prod_coll .proimage .pro_img_box{
            background: linear-gradient(to left,rgba(0,0,0,0.01),rgba(0,0,0,0.01)), <?php echo $color_code; ?>90;
         }
                ...
                <!--   <div class="change-language desktopHide mainLangague">
                    <ul>
                        <li>
                            ...
                            <!-- <a value="en" <?php if($this->session->userdata('language') == 'en') echo "selected"; ?>>EN</a> 
                        </li>
                        <li>
                            <input type="text" readonly name="" value="he" >
                            <!-- <a value="he" <?php if($this->session->userdata('language') == 'he') echo "selected"; ?>>HB</a> 
                        </li>
                    </ul>
                </div>  -->
                  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                   ...
                   <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <div class="mobileHeader">
                      <div class="row">
                        <div class="col-6">
                           <img src="<?php echo base_url(); ?>uploads/company/<?php echo $company_logo; ?>" alt="logo" style="height:60px;">
                        </div>
                        <div class="col-6">
                          <button>
                    ...
                    <ul class="navbar-nav ml-auto">               
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="https://app.galtex.co.il/employees/profile#myOrder"><?php echo lang('personal_area'); ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo base_url(); ?>"><?php echo lang('about_us'); ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="modal" data-target="#havingTroubleModal"><?php echo lang('contact_us'); ?></a>
                        </li>
 ...
 <li style="text-align: center;">
       <div class="change-language desktopHide mainLangague" style="padding-top: 35px;">
                   ...
                   <!--  <select class="form-control change-language col-sm-2">
                      ...
                      <p><?php echo lang('social_media'); ?> </p>
               ...
               <div class="filterBox">
                  ...
                  <div class="filterCategory">
                     <h4><?php echo lang('filter_category'); ?></h4>
                     <p><?php echo lang('category'); ?> </p>
                     <ul class="list-unstyled catlist_item">
                                <?php if($categories['data']['total_records']) { foreach($categories['data']['records'] as $category) { ?>
                                <li class="wow fadeInLeft" data-wow-delay="0.3s">
								<input type="checkbox" id="category_<?php echo $category['category_guid']; ?>" name="main_category[]" value="<?php echo $category['category_guid']; ?>" <?php if(in_array($category['category_guid'], $main_categories)) echo "checked"; ?> class="main_categories2" />
