                        ...
                        <table class="table table-striped table-bordered my-datatable">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-danger btn-icon" onclick="showConfirmationBox('<?php echo lang('are_you_sure'); ?>','<?php echo lang('are_you_sure_delete'); ?><?php echo $value['category_name']; ?><?php echo lang('category'); ?>?','<?php echo lang('yes'); ?>','<?php echo lang('no'); ?>','delete/<?php echo $value['category_guid']; ?>')" title="<?php echo lang('delete_category'); ?>"><i class="zmdi zmdi-delete"></i></button>
                                </td>
                           </tr>
                            <?php $i++; } } ?>
                            </tbody>
