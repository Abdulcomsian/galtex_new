$(document).ready(function () {
  ...
  $(".product_main_item").slick({
    slidesToShow: 1,
    slidesToScroll: 1,
    arrows: false,
    dots: false,
    fade: true,
    asNavFor: ".thumb_inner",
    rtl: rtl_slick(),
  });
  $(".thumb_inner").slick({
    slidesToShow: 4,
    slidesToScroll: 1,
    asNavFor: ".product_main_item",
    dots: false,
    arrows: true,
    focusOnSelect: true,
    rtl: rtl_slick(),
  ...
  if ($(window).width() < 992) {
    $(".has_dd").append(
      "<span class='dd_arrow'> <i class='fas fa-angle-down'></i></span>"
    );
  ...
  $(".home_slider").on("init", function (e, slick) {
    var $firstAnimatingElements = $(".home_slide:first-child").find(
      "[data-animation]"
    );
  ...
  $(".home_slider").on(
    ...
    function (e, slick, currentSlide, nextSlide) {
      var $animatingElements = $(
        '.home_slide[data-slick-index="' + nextSlide + '"]'
      ).find("[data-animation]");
...
$("body").on("change", "input.budget-categories", function () {
  let budget_categories = $("input.budget-categories:checkbox:checked")
    .map(function () {
      return this.value;
    })
    .get();
...
$("body").on("change", "input.main_categories", function () {
  let main_categories = $("input.main_categories:checkbox:checked")
    .map(function () {
      return this.value;
    })
    .get();
...
$("body").on("change", "input.budget-categories2", function () {
  let budget_categories = $("input.budget-categories2:checkbox:checked")
    .map(function () {
      return this.value;
    })
    .get();
...
$("body").on("change", "input.main_categories2", function () {
  let main_categories = $("input.main_categories2:checkbox:checked")
    .map(function () {
      return this.value;
    })
    .get();
